...
Code Switching is a ready to be produced Common Voice modality where contributors produce speech that naturally switches between two or more languages within a single utterance. This is a subproject within the [Spontaneous Speech](https://github.com/common-voice/spontaneous-speech) repository, currently gated to alpha testers.
